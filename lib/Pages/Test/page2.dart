      ...
      bottomNavigationBar: BottomAppBar(
        ...
        child: SizedBox(
          ...
          child: ElevatedButton(
            ...
            onPressed: () {
              // Add logic for the submit button action
              // You can use the checklist to determine which chapters are selected
              // For example, you can print the selected chapters to the console
              printSelectedChapters();
              Navigator.push(context,
                  MaterialPageRoute(builder: (ctx) => const TogglePage()));
            },
            child: const Text(
              'Submit',
              style: TextStyle(
